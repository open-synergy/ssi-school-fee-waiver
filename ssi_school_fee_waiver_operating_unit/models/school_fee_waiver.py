...
class SchoolFeeWaiver(models.Model):
    """Extend School Fee Waiver with single operating unit support.

    Restricts each fee waiver record to one operating unit, and
    derives ``operating_unit_id`` from the school of the selected
