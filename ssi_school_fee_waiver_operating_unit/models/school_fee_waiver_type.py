...
class SchoolFeeWaiverType(models.Model):  # pylint: disable=too-few-public-methods
    """Extend School Fee Waiver Type with single operating unit support.

    Restricts each fee waiver type record to one operating unit, for
