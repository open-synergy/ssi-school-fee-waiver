...
> **Extends:** ssi_school_fee_waiver — model `school_fee_waiver_reason`, action `01-create`

## Additional Fields

When this module is installed, the create form gains one optional field:

- **Operating Unit**: Select the operating unit this Fee Waiver Reason belongs to. Leave
...
- The Fee Waiver Reason list is filtered by a record rule: a user only sees records that
