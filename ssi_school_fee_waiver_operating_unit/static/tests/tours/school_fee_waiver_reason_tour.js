...
odoo.define(
    "ssi_school_fee_waiver_operating_unit.school_fee_waiver_reason_tour",
    function (require) {
        "use strict";

        var tour = require("web_tour.tour");

        // IK: docs/school_fee_waiver_reason/01-create.md (E1 delta --
        // Additional Fields). Navigation (open menu -> New) is taken
        // from the base IK ssi_school_fee_waiver/docs/
        // school_fee_waiver_reason/01-create.md Flow steps 1-2 -- see
        ...
        tour.register(
            "ssi_school_fee_waiver_operating_unit_school_fee_waiver_reason_create",
            {
                test: true,
                url: "/web",
            },
            [
                ...
                // Fee Waiver > Fee Waiver Reasons menu.
                ...
                // skip straight to the Fee Waiver Reasons leaf item.
                {
