...
class TestSchoolFeeWaiverAdmissionOperatingUnit(
    YamlTransactionCase
):  # pylint: disable=too-few-public-methods
    """Cover Operating Unit derivation for Admission-sourced waivers.
    ...
    def test_school_fee_waiver_admission_operating_unit(self):
        """Run every Admission Operating Unit derivation scenario."""
        self.run_yaml_scenario(
            "test_data_school_fee_waiver_admission_operating_unit.yaml"
        )
